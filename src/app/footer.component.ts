        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div class="col-span-1 lg:col-span-2">
            ...
            <div class="flex gap-4">
              <a href="https://www.instagram.com/dark___seid__?igsh=MWVycGpyaTg1OGRjcQ==" target="_blank" rel="noreferrer" aria-label="Instagram" class="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center text-gray-400 hover:bg-emerald-600 hover:text-white transition-colors">
                <mat-icon>photo_camera</mat-icon>
              </a>
              <a href="https://www.linkedin.com/in/bharath-krishnan-t-9bb641340?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noreferrer" aria-label="LinkedIn" class="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center text-gray-400 hover:bg-emerald-600 hover:text-white transition-colors">
          ...
          <div>
            ...
            <div class="text-sm text-gray-400 space-y-4">
              ...
              <p class="flex items-center gap-2">
                <mat-icon class="text-emerald-500 text-sm">call</mat-icon>
                <a href="tel:9361478894" class="hover:text-white transition-colors">9361478894</a>
              </p>
              <p class="flex items-start gap-2">
                <mat-icon class="text-emerald-500 text-sm mt-0.5">photo_camera</mat-icon>
                <a href="https://www.instagram.com/dark___seid__?igsh=MWVycGpyaTg1OGRjcQ==" target="_blank" rel="noreferrer" class="hover:text-white transition-colors break-all">Instagram Profile</a>
              </p>
              <p class="flex items-start gap-2">
                <mat-icon class="text-emerald-500 text-sm mt-0.5">business_center</mat-icon>
                <a href="https://www.linkedin.com/in/bharath-krishnan-t-9bb641340?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noreferrer" class="hover:text-white transition-colors break-all">LinkedIn Profile</a>
              </p>
              <p class="flex items-center gap-2">
